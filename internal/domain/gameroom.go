...
type GameRoom struct {
	...
	HostID         uint           `json:"host_id"`                    // HostID is automatically recognized as the foreign key for the Host field because it follows the naming convention FieldNameID (where FieldName is Host).
